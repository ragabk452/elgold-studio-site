...
(function () {
  ...
  var T = {
    en: {
      ...
      'work.viewAll': 'View all works →', 'work.allTitle': 'All works',
      ...
      'about.t1': 'A personal studio led by', 'about.t2': 'Kareem Ragab',
    ...
    ar: {
      ...
      'work.viewAll': 'شوف كل الأعمال →', 'work.allTitle': 'كل الأعمال',
      ...
      'about.t1': 'استوديو شخصي بقيادة', 'about.t2': 'كـــريـــم رجـــب',
      ...
      'cta.pill': 'يلا نتكلم', 'cta.t1': 'جاهـز تبنــي', 'cta.t2': 'حاجة فخمة؟',
  ...
  function initSnap() {
    ...
    // نقل فوري موثوق للموضع المحفوظ الصح (مجرّب ومضمون من أي مكان، من غير إيقاف لينيس فما يكسرش الظهور)
    snapNav = function (el) {
